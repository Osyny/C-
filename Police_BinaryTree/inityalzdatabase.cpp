#include "inityalzdatabase.h"

InityalzDataBase::InityalzDataBase()
{
    initDataBase();
}

const char *InityalzDataBase::initRandOffence()
{
    int symb = 0;
...
void InityalzDataBase::initDataBase()
{
    ...
    for(int i = 0 ; i < numCars; i++)
    {
        ...
        for (int j = 0; j < numOffences; j++)
           carDataBase.addOffence(carRandNumber, initRandOffence());
    }
}
